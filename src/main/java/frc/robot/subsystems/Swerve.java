...
public class Swerve extends SwerveDrivetrain implements Subsystem {
    ...
    public void updateVision() {
        if (Robot.isReal()) {
            ...
            LimelightHelpers.SetRobotOrientation(VisionConstants.limelightLeftName, yaw, 0, 0, 0, 0, 0);
            LimelightHelpers.SetRobotOrientation(VisionConstants.limelightCenterName, yaw, 0, 0, 0, 0, 0);
            LimelightHelpers.SetRobotOrientation(VisionConstants.limelightRightName, yaw, 0, 0, 0, 0, 0);
            ...
            if (centerPose.rawFiducials.length > 0) {
